...
class VMScheduleGridViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.rowState = (indexPath.row == 0) ? VMScheduleGridTableViewCell.ScheduleGridCellStateEnum.HeaderRow : VMScheduleGridTableViewCell.ScheduleGridCellStateEnum.NonHeaderRow
